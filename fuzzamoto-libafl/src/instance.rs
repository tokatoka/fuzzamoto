...
use fuzzamoto_ir::{
    ...
    BlockGenerator, BlockTxnGenerator, BlockTxnMutator, BloomFilterAddGenerator,
...
use crate::{
    feedbacks::{CaptureTimeoutFeedback, ProbeFeedback},
    input::IrInput,
        ...
        + EventReceiver<IrInput, ClientState>,
{
    pub fn run(mut self, state: Option<ClientState>) -> Result<(), Error> {
        ...
        let mut stages = tuple_list!(
            probing, // important: probing stage must be put at the beginning
